...
containing a value of this type.
 ...
 The platform's desired fixed width for a dialog along the minor axis
    ...
    public static final class drawable {
        ...
        public static final int tp=0x7f020058;
    }
 ...
 The maximum number of action buttons that should be permitted within
    ...
    public static final class raw {
        public static final int y1x=0x7f050000;
        public static final int yx=0x7f050001;
    }
        ...
        */
        ...
        /**  These attributes are meant to be specified and customized by the app.
         ...
         be present and whether it should overlay content. 
           ...
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMajor com.example.test:windowFixedHeightMajor}</code></td><td> A fixed height for the window along the major axis of the screen,
             that is, when in portrait.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMinor com.example.test:windowFixedHeightMinor}</code></td><td> A fixed height for the window along the minor axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMajor com.example.test:windowFixedWidthMajor}</code></td><td> A fixed width for the window along the major axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMinor com.example.test:windowFixedWidthMinor}</code></td><td> A fixed width for the window along the minor axis of the screen,
             that is, when in portrait.</td></tr>
